          ...
          <div className="grid grid-cols-2 gap-6 md:grid-cols-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex gap-3">
                ...
                <a href="https://twitter.com" target="_blank" rel="noreferrer" className="flex h-8 w-8 items-center justify-center rounded-full bg-blue-400 text-white hover:scale-110 transition-transform">
